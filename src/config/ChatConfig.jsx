...
const ChatConfig = {
  ...
  welcomeMessage: "Hello! I'm your BeautyOnWheel AI assistant. How can I help you today? Ask about our services, booking, pricing, or request to speak with a human agent anytime!",
  
  // Offline Message (when server is unreachable)
  offlineMessage: "We're currently in AI-only mode. You can still chat with our AI assistant!",
  
  // Real-time Server Configuration
  // Set this to your Socket.io server URL for human agent support
  // Leave null for AI-only mode
  serverUrl: null, // e.g., "https://your-socket-server.com"
